...
function App() {
          ...
          return (
            <div key={index}>
              ...
              <div>
                ...
                ) : //<Editform id={user.id} age={user.age} index={index} name={user.name}/>
                null}
              </div>
            </div>
          );
  ...
  // function Editform({id,age,index,name}:EditProps){
  //   return(
  //     <form
  //     onSubmit={async (e) => {
  //       e.preventDefault();
  ...
  //       await updateDoc(userDoc, newFields);
  //     }}//updateName(e, id, age, index)
  //   >
  //     <input
  //       type="text"
  //       onChange={ (e) => { //온체인지가 하자가 있다.
